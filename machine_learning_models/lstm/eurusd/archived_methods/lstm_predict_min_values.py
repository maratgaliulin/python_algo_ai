...
def predict_min_value_with_lstm_model(df:pd.DataFrame, test_df:pd.DataFrame, validation_df:pd.DataFrame, base_dir:str):
    ...
    complete_df_dir = base_dir + '/lstm_regressor_predict_min_values-2025-04-07.pkl'
    ...
    if(complete_files_exist):        
        ...
        with open(base_dir + '/lstm_regressor_predict_min_values-2025-04-07.pkl', 'wb') as file:
